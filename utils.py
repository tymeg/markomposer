...
DEFAULT_LENGTH_PRECISION = DEFAULT_TICKS_PER_BEAT // 8

# 0 to whole note
DEFAULT_LENGTHS_RANGE = DEFAULT_TICKS_PER_BEAT * DEFAULT_BEAT_VALUE
# DEFAULT_LENGTHS_RANGE = 2 * DEFAULT_TICKS_PER_BEAT * DEFAULT_BEAT_VALUE
