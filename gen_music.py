...
class MusicGenerator:
    ...
    def __pick_tuple(
        ...
        if first_tuples:
            ...
            if next_tuple is None:
                # "new start"
                # try finding n-1-gram with the first note tuple as last generated
                if messages:
                ...
                if ret is not None and len(ret[0]) > 1:
                    ...
                    # choose new nminus1gram without the common last/first note
    ...
    def generate_music_with_melody_ngrams(
        ...
        while True:
            ...
            next_note, next_note_length, next_pause = next_tuple
            next_note_length, next_pause = self.mm.round_time(
                next_note_length,
                True,
                True,
            ...
            if time_in_strong_beat == 0:  # maybe shrink pause
                next_pause = 0
            else:
                time_in_strong_beat += next_pause
                if (
                    time_in_strong_beat > strong_beat_length
                    and time_in_strong_beat % strong_beat_length != 0
                ):
                    next_pause -= time_in_strong_beat - strong_beat_length
                    time_in_strong_beat = 0
            ...
            total_time += next_note_length + next_pause

            prev_note, prev_pause = next_note, next_pause
